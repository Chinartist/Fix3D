...
from src.wan_v2v import WanV2V
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_dir', type=str, default='/nvme0/public_data/Occupancy/proj/img2img-turbo/inputs/video_6', help='path to the input image')
    parser.add_argument('--prompt', type=str, default='', help='the prompt to be used')
    parser.add_argument('--num_cycle', type=int, default=1, )
    parser.add_argument('--model_path', type=str, default='/nvme0/public_data/Occupancy/proj/img2img-turbo/outputs/pix2pix_turbo/stage0_render/checkpoints/model_1710.pkl', help='path to a model state dict to be used')
    parser.add_argument('--output_dir', type=str, default='/nvme0/public_data/Occupancy/proj/img2img-turbo/inputs/video_6_post', help='the directory to save the output')
    ...
    model = WanV2V( pretrained_path=args.model_path)
    model.scheduler.set_timesteps(1, device=torch.device("cuda"))
